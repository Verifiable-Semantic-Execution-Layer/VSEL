...
// Module: VSEL.Mapping.Observable
// Imports: Init VSEL.Foundations.State VSEL.Foundations.Input VSEL.Foundations.Transition VSEL.Mapping.SemanticMapping VSEL.Mapping.Commutativity
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_VSEL_Mapping_Observable(uint8_t builtin, lean_object* w) {
lean_object * res;
