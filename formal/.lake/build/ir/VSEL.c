...
lean_object* initialize_VSEL_Refinement_FormalToSIR(uint8_t builtin, lean_object*);
lean_object* initialize_VSEL_Refinement_SIRToConcrete(uint8_t builtin, lean_object*);
lean_object* initialize_VSEL_Refinement_ConcreteToConstraint(uint8_t builtin, lean_object*);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_VSEL_Refinement_FormalToSIR(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_VSEL_Refinement_SIRToConcrete(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_VSEL_Refinement_ConcreteToConstraint(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_VSEL_Composition_Soundness(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
